...
public static void asociarInstancias(int sel){
    ...
    clasFinal.clear();
    propFinal.clear();
    ContentMainJFrame.getConjuntoClassInstances().set(sel, clasFinal);
    ContentMainJFrame.getConjuntoPropInstances().set(sel, propFinal);
}
