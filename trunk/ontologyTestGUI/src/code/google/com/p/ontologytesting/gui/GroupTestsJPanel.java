...
public class GroupTestsJPanel extends javax.swing.JPanel {
    ...
    public GroupTestsJPanel(int num) {
        ...
        for (int i = 0; i <= num; i++) {
            instAyudaPanel.add(new TestInstancesTFJPanel(0));
            retAyudaPanel.add(new TestInstancesTextAreaJPanel(0));        
            realAyudaPanel.add(new TestInstancesQueryJPanel());
            satAyudaPanel.add(new TestInstancesTFJPanel(1));
            clasAyudaPanel.add(new TestInstancesTextAreaJPanel(1));
        }
    ...
    public GroupTestsJPanel(String path){
        ...
        realAyudaPanel.setLayout(new BoxLayout(getRealAyudaPanel(), BoxLayout.Y_AXIS));
        opcionTextInstPanel.add(new TestInstancesTextJPanel());    
        opcionTextRetPanel.add(new TestInstancesTextAreaJPanel(0));
        opcionTextClasPanel.add(new TestInstancesTextAreaJPanel(1));
        opcionTextSatPanel.add(new TestInstancesTextJPanel());
        opcionTextRealPanel.add(new TestInstancesTextJPanel());
                ...
                while(qi.hasNext()){   
                    ...
                    if(s.getTestName().equals("Instanciación") || s.getTestName().equals("Satisfactibilidad")){
                        if(s.getTestName().equals("Instanciación")){
                            testTF = new TestInstancesTFJPanel(0);
                        }else if(s.getTestName().equals("Satisfactibilidad")){
                            testTF = new TestInstancesTFJPanel(1);
                        }
        ...
        if(instAyudaPanel.getComponentCount()<8){
            while(instAyudaPanel.getComponentCount()<8){
                pInst = new TestInstancesTFJPanel(0);
        ...
        if(satAyudaPanel.getComponentCount()<8){
            while(satAyudaPanel.getComponentCount()<8){
                pSat = new TestInstancesTFJPanel(1);
    ...
    private void initComponents() {
        ...
        labelInstPanel1 = new javax.swing.JPanel();
        labelInstLabel2 = new javax.swing.JLabel();
        ...
        opcionAyudaSatPanelLayout.setHorizontalGroup(
            ...
            .addGroup(opcionAyudaSatPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane9, javax.swing.GroupLayout.DEFAULT_SIZE, 813, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        contentSatTabedPanelLayout.setHorizontalGroup(
            ...
            .addGroup(contentSatTabedPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(contentSatTabedPanelLayout.createSequentialGroup()
                    .addComponent(tabbedPaneSat, javax.swing.GroupLayout.DEFAULT_SIZE, 838, Short.MAX_VALUE)
                    .addContainerGap()))
        );
        ...
        labelInstLabel2.setText("                      CONSULTAS                               RESULTADO ESPERADO");

        javax.swing.GroupLayout labelInstPanel1Layout = new javax.swing.GroupLayout(labelInstPanel1);
        labelInstPanel1.setLayout(labelInstPanel1Layout);
        labelInstPanel1Layout.setHorizontalGroup(
            labelInstPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(labelInstPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelInstLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 397, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(135, Short.MAX_VALUE))
        );
        labelInstPanel1Layout.setVerticalGroup(
            labelInstPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(labelInstPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelInstLabel2)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        clasAyudaPanelLayout.setHorizontalGroup(
            ...
            .addGroup(clasAyudaPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(labelInstPanel1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        helpButton.setText("Descripcion de los Tests");
        ...
        contentPanelLayout.setHorizontalGroup(
            ...
            .addGroup(contentPanelLayout.createSequentialGroup()
                ...
                .addGroup(contentPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(testsTabbedPane, javax.swing.GroupLayout.DEFAULT_SIZE, 859, Short.MAX_VALUE))
                .addContainerGap())
        );
...
// TODO add your handling code here:
    ...
    private javax.swing.JLabel labelInstLabel2;
    ...
    private javax.swing.JPanel labelInstPanel1;
    ...
    public static void inicializarVariables(){
        setSinConsultas(false);
        setAmbosNecesarios(false);
        ...
        if(todosTienenNombre()==true && todosSonValidos()==true && getTestYaExiste()==false
            ...
            int n = JOptionPane.showConfirmDialog(comp, "¿Quiere guardar estos tests " +
                ...
                if (n == JOptionPane.YES_OPTION){
                    ...
                    instCompletado=false;
                    retCompletado=false;
                    realCompletado=false;
                    satCompletado=false;
...
public static void formatoIncorrecto(int tab){
    ...
    if(sel==0){
        if(instCompletado==false){
                ...
                descPanel = (DescripcionJPanel) panelInst.getComponent(0);
                    ...
                    if(getInstTextName()==true){
                        ...
                        if(descPanel.getNombreTextField().equals("") && (!test.getQuery().equals("") || !test.isTestFalse().equals(test.isTestTrue()))){
                            ...
                            "El nombre del test es obligatorio.","Warning Message",JOptionPane.WARNING_MESSAGE);
                            ...
                            if(!query.equals("") && !resExpT.equals(resExpF)){
                                ...
                                ((!test.getQuery().equals("") && test.isTestFalse().equals(test.isTestTrue())))){
                                JOptionPane.showMessageDialog(frame,"Test de Instanciacion: " +
                                        "Ambos campos CONSULTA y RESULTADO ESPERADO " +
            ...
            if(testYaExiste(scenario.getNombre())==true){
                ...
                if(descPanel.getNombreTextField().equals("") && (!conjuntoQuerys.equals("") || (!conjuntoResult.equals("")))){
                    JOptionPane.showMessageDialog(frame,"Test de Instanciacion: " +
                    "El nombre del test es obligatorio.","Warning Message",JOptionPane.WARNING_MESSAGE);        
                    setInstTextName(false);
                }else if(descPanel.getNombreTextField().equals("") && (conjuntoQuerys.equals("") && (conjuntoResult.equals("")))
                        && MainJPanel.getCollectionTest().getScenariotest().size()==0){
                    JOptionPane.showMessageDialog(frame,"Test de Instanciacion: " +
                    "No ha creado ningun test para ejecutar.","Warning Message",JOptionPane.WARNING_MESSAGE); 
                    setInstTextName(false);
                }else if(!descPanel.getNombreTextField().equals("") && (conjuntoQuerys.equals("") && (conjuntoResult.equals("")))){
                    JOptionPane.showMessageDialog(frame,"Test de Instanciacion: " +
                    "Al menos debe introducir una consulta para ejecutar el test.","Warning Message",JOptionPane.WARNING_MESSAGE); 
                    setInstTextName(false);
                }else{
                    ...
                    if(!conjuntoQuerys.equals("") && !conjuntoResult.equals("")){
                        ...
                        JOptionPane.showMessageDialog(frame,"Test Instanciacion: " +
                        "Ambos campos CONSULTA y RESULTADO ESPERADO " +
                        "son obligatorios.","Warning Message",JOptionPane.WARNING_MESSAGE);
                        setAmbosNecesarios(true);
                    }else if(conjuntoQuerys.equals("") && conjuntoResult.equals("")){
                    ...
                    if(getInstTextName()==true){
                        if(testYaExiste(scenario.getNombre())==false){
                            if(getSinConsultas()==false){
                                if(getAmbosNecesarios()==false){
                                    if(getValidoInst()==true){
                                        if(aux==1){
                ...
                for(int i=1;i<totalRet;i++){
                    ...
                    if(descPanel.getNombreTextField().equals("") && (!test2.getQuery().equals("") || !test2.getQueryResult().equals(""))){
                        ...
                        setRetTextName(false);
                            ...
                            ((test2.getQuery().equals("") && !test2.getQueryResult().equals("")))){
                                varAux=1;
                                JOptionPane.showMessageDialog(frame,"Test de Recuperacion: " +
                                        "Ambos campos CONSULTA y RESULTADO ESPERADO " +
                                        "son obligatorios.","Warning Message",JOptionPane.WARNING_MESSAGE);
                ...
                if(AddInstancesJPanel.isStateNuevo()==true){
                    ...
                    if(getRetTextName()==true && getValidoRet()==true && getTestYaExiste()==false){
                        if(aux==1){
                            ...
                            if(hayInstanciasAsociadas(instancias)==false){
                                int n = JOptionPane.showConfirmDialog(comp, "El Test de " +
                                    "Recuperacion no tiene instancias asociadas. ¿Desea " +
                                    "continuar?", "Warning Message",JOptionPane.YES_NO_OPTION);
                                if (n == JOptionPane.NO_OPTION){    
                                    setNoHayInstancias(true);
                                }
                ...
                for(int i=1;i<totalReal;i++){
                    ...
                    if(descPanel.getNombreTextField().equals("") && (!test1.getQuery().equals("") || !test1.getQueryResult().equals(""))){
                        ...
                        setRealTextName(false);
                            ...
                            || (test1.getQuery().equals("") && !test1.getQueryResult().equals(""))){
                                varAux=1;
                                JOptionPane.showMessageDialog(frame,"Test de Realizacion: " +
                                        "Ambos campos CONSULTA y RESULTADO ESPERADO son obligatorios.",
                                    "Warning Message",JOptionPane.WARNING_MESSAGE);
                                setAmbosNecesarios(true);
                    }else if(test1.getQuery().equals("") && test1.getQueryResult().equals("")){
                        if(varAux==0){
                    ...
                    if(descPanel.getNombreTextField().equals("") && (!test.getQuery().equals("") || !test.isTestFalse().equals(test.isTestTrue()))){
                        ...
                        setSatTextName(false);
                            ...
                            test.getQuery().equals("") && !test.isTestFalse().equals(test.isTestTrue())){
                                varAux=1;
                                JOptionPane.showMessageDialog(frame,"Test de Satisfactibilidad: " +
                                        "Ambos campos CONSULTA y RESULTADO ESPERADO son obligatorios.","Warning Message",
            ...
            if(AddInstancesJPanel.isStateNuevo()==true){
                ...
                if(!conjuntoQuerys.equals("") && !conjuntoResult.equals("")){
                    ...
                    for(int i=0; i<cQuery.length;i++){
                        ...
                        JOptionPane.showMessageDialog(frame,"Test Satisfactibilidad: " +
                        "Ambos campos CONSULTA y RESULTADO ESPERADO " +
                        "son obligatorios.","Warning Message",JOptionPane.WARNING_MESSAGE);
                        setAmbosNecesarios(true);
                    }
...
public static boolean testYaExiste(String nombre){
    ListIterator li;
    ArrayList<ScenarioTest> lista = MainJPanel.getCollectionTest().getScenariotest();
    li = lista.listIterator();
    while(li.hasNext()){
        ScenarioTest scenario = (ScenarioTest) li.next();
        String n = scenario.getNombre();
        if(n.equals(nombre)){
            return true;
        }
    }
...
public static boolean inListSparqlQuerys(SparqlQueryOntology query){
            ...
            if(!cQuery[i].equals("")){
                if(i<tamInst){
                    ...
                    if(j<tamInst){
                        ...
                        TestInstancesTFJPanel instP = new TestInstancesTFJPanel(0);
                        instP.setQuery(cQuery[i]);
                        GroupTestsJPanel.getInstAyudaPanel().add(instP);
                    }
                }
            }else{
                j++;
            ...
            if(!cQuery[i].equals("")){
                if(i<tamInst){
                    ...
                    if(j<tamInst){
                        ...
                        TestInstancesTextAreaJPanel instP = new TestInstancesTextAreaJPanel(0);
                        instP.setQuery(cQuery[i]);
                        GroupTestsJPanel.getRetAyudaPanel().add(instP);
                    }
                }
            }
        }
            ...
            if(!cQuery[i].equals("")){
                if(i<tamInst){
                    ...
                    if(j<tamInst){
                        ...
                        TestInstancesTFJPanel instP = new TestInstancesTFJPanel(1);
                        instP.setQuery(cQuery[i]);
                        GroupTestsJPanel.getSatAyudaPanel().add(instP);
                    }
                }
            }else{
                j++;
            ...
            if(!cQuery[i].equals("")){
                if(i<tamInst){
                    ...
                    if(j<tamInst){
                        ...
                        TestInstancesTextAreaJPanel instP = new TestInstancesTextAreaJPanel(1);
                        instP.setQuery(cQuery[i]);
                        GroupTestsJPanel.getClasAyudaPanel().add(instP);
                    }
                }
            }
        }
    ...
    public static boolean getAmbosNecesarios() {
        return ambosNecesarios;
    }
