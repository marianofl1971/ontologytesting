...
public class TestSimpleRetClas extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        labelRetLabel.setText(java.util.ResourceBundle.getBundle(Configuration.getInstance().cargarDriver().getProperty("IDIOMA")).getString("______________________________________CONSULTAS_________________________________________________RESULTADO_ESPERADO"));
        ...
        tabbedPaneRet.addTab(java.util.ResourceBundle.getBundle(Configuration.getInstance().cargarDriver().getProperty("IDIOMA")).getString("Formato_ayuda"), opcionAyudaRetPanel);
        ...
        tabbedPaneRet.addTab(java.util.ResourceBundle.getBundle(Configuration.getInstance().cargarDriver().getProperty("IDIOMA")).getString("Formato_Texto"), opcionTextRetPanel);
