...
private void examinarProyectoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_examinarProyectoActionPerformed
// TODO add your handling code here:
     openFile(this.getUbicacionProyectoTextField());//GEN-LAST:event_examinarProyectoActionPerformed
}                                                
    ...
    private void openFile(JTextField textfield){
        ...
        if (option == JFileChooser.APPROVE_OPTION) {
          ...
          carpetaProyectoTextField.setText(path+"\\"+getNombreProyectoTextField());
        }
    }
