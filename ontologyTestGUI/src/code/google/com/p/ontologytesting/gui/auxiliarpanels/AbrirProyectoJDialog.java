...
public class AbrirProyectoJDialog extends javax.swing.JDialog{
    ...
    public AbrirProyectoJDialog(java.awt.Frame parent, boolean modal) {
        ...
        this.setTitle(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Ubicación_de_la_Ontología_y_el_Namespace"));
    ...
    private void initComponents() {
        ...
        jLabel1.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Datos_del_Proyecto"));

        jLabel2.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Compruebe_que_los_siguientes_datos_son_correctos._En_caso_contrario,_realice_las_modificaciones_oportunas:"));

        jLabel3.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Ubicación_de_la_ontología_con_la_que_va_a_trabajar:"));
        ...
        jLabel4.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Namespace_de_la_ontologia:"));

        cancelButton.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Cancelar"));
        ...
        aceptarButton.setText(java.util.ResourceBundle.getBundle(Configuration.getPropiedades().getProperty("IDIOMA")).getString("Aceptar"));
