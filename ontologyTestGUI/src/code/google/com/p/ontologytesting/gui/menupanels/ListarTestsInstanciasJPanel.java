...
public class ListarTestsInstanciasJPanel extends javax.swing.JPanel implements ListSelectionListener{
    ...
    private FileChooserSelector util = new FileChooserSelector();
    ...
    public ListarTestsInstanciasJPanel(List<ScenarioTest> listaFich,List<Instancias> listaInst, boolean isTest) {
        ...
        if(isTest==true){
            if(listaFich.size()>0){
                setScenarioSelect(scenarioSelect.buscarScenario(this.getListaFicheros(),modeloTests.get(list.getLeadSelectionIndex()).toString()));
            ...
            if(listaInst.size()>0){
                setInstanciaSelect(instanciaSelect.buscarInstancias(this.getListaFicherosInst(), modeloInstancias.get(list.getLeadSelectionIndex()).toString()));
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        for(int i=0;i<object.length;i++){
            if(this.getIsTest()==false){
                setInstanciaSelect(instanciaSelect.buscarInstancias(this.getListaFicherosInst(),(String) object[i]));
                if(instanciaSelect.instanciaYaExiste(linst,(String) object[i])==false){
                    linst.add(getInstanciaSelect());
                }
            }else{
                setScenarioSelect(scenarioSelect.buscarScenario(this.getListaFicheros(),(String) object[i]));
                if(scenarioSelect.testYaExiste(l,(String) object[i])==false){
                    l.add(getScenarioSelect());
                }
            }  
        }
    ...
    public void updateLabel (String name) { 
        if(this.getIsTest()==false){
            Instancias inst = instanciaSelect.buscarInstancias(this.getListaFicherosInst(),name);
            ...
            ScenarioTest scenario = scenarioSelect.buscarScenario(this.getListaFicheros(),name);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(descScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 263, Short.MAX_VALUE))
        );
